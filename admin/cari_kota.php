...
<div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <tbody>
                                <?php $No=1; ?>
                                    <?php $ambildata=$koneksi->query("SELECT * FROM kota JOIN provinsi ON kota.id_provinsi=provinsi.id_provinsi WHERE  
                                ...
                                nama_provinsi LIKE '%$keyword%'");?> 
                                    <?php while($pecah = $ambildata->fetch_assoc()){?>
                                               ...
                                               <td><?php echo $pecah['nama_provinsi'];?></td>
                                                    ...
                                                    <td><a href ="hapus_kota.php?id_kota=<?php echo $pecah['id_kota']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-purple">Delete</a>   
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
