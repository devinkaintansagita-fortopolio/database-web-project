                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-light" id="dataTable" width="100%" cellspacing="50"style="background-color: Pink;">
                                    <thead>
                                        ...
                                        <tbody>
                                            <?php 
                                              $ambildata =mysqli_query($koneksi, "SELECT * FROM dokter JOIN spesialis ON dokter.id_spesialis=spesialis.id_spesialis JOIN jenis_spesialis ON spesialis.id_jenis_spesialis=jenis_spesialis.id_jenis_spesialis");
                                                 $No =1 ;
                                            ...
                                            ?>
                                               <tr>
                                                   ...
                                                   <td><?php echo $db['password_dokter'];?></td>
                                                    ...
                                                    <td>Rp.<?php echo number_format($db['tarif_dokter']);?></td>
                                                    <td> <img src="../foto_dokter/<?php echo $db['foto_dokter'];?>" width="100"></td>

                                                    <td>  
                                                        <a href ="hapus_dokter.php?id_dokter=<?php echo $db['id_dokter']?>" onclick ="return confirm ('Apakah anda yakin ingin menghapus data?')"name="hapus" class="btn btn-purple"> Hapus </a>   
                                        <?php $No++;
                                        }
                                        ?> 
                                        </tbody>
