...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        while ($db = $ambildata->fetch_assoc()) {
            ...
            <br>
            <a href ="nota_penyakit.php?id_nota_konsul=<?php echo $db['id_nota_konsul']?>" onclick ="return confirm ('Apakah anda ingin memberikan diagnosis Anda?')"name="diagnosa" class="btn btn-purple"> Diagnosa </a>   
            <hr>
        <?php $No++;
        }
        ?>
