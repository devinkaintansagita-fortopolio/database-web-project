				...
				<div class="row">
					<div class="col-sm-10 col-sm-offset-1">
						<div class="login-container">
							<div class="center">
								<h1>
									<i class="ace-icon fa fa-tachometer black"></i>
										...
										<div class="widget-main">
											...
											<form class="login100-form validate-form" method="post" style="padding-top:20px; padding-bottom:40px;">
					                            <div class="wrap-input100 validate-input m-b-26" data-validate="Username is required">
                                                    ...
                                                    <input class="input100" type="text" name="username_dokter" placeholder="Masukkan Username">
                                                    <span class="focus-input100"></span>
                                                </div>
												<div class="wrap-input100 validate-input m-b-26" data-validate = "Password is required">
													<i class="ace-icon fa fa-lock"></i>
                                                    <input class="input100" type="password" name="password_dokter" placeholder="Masukkan Password">
                                                    <span class="focus-input100"></span>
                                                </div>
												<div class="space-6"></div>
                                            ...
                                            <?php
                                                ...
                                                {
                                                    $username=$_POST["username_dokter"];
                                                    $password=$_POST["password_dokter"];
                                                    $ambil=$koneksi->query("SELECT * FROM dokter
                                                        WHERE username_dokter='$username' AND password_dokter='$password'");
                                                    $akunyangcocok=$ambil->num_rows;
                                                    if($akunyangcocok==1)
                                                    {
                                                        $akun=$ambil->fetch_assoc();
                                                        $_SESSION["dokter"]=$akun;
