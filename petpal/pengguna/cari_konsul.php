...
<div class="button-section" style="text-align: center; margin-top: 20px;">
    <a href="index.php?halaman=dokter" class="btn btn-purple" style="background-color: #8e44ad; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none;"> Kembali </a>
</div>
