                                    ...
                                    <table class="table table-bordered text-light" id="dataTable" width="100%" cellspacing="50"style="background-color: Pink;">
                                        <thead>
                                            ...
                                            <tbody>
                                                ...
                                                $ambildata =mysqli_query($koneksi, "SELECT * FROM hewan JOIN pengguna ON hewan.id_pengguna=pengguna.id_pengguna WHERE hewan.id_pengguna = '$id_pengguna'");
                                                    $No =1 ;
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $db['jenis_hewan'];?></td>
                                                        ...
                                                        <td>  
                                                            ...
                                                            <a href="edit_hewan.php?halaman=edit_hewan&id_hewan=<?php echo $db['id_hewan'] ?>" class="btn btn- btn-purple">Edit</a> 
                                            <?php $No++;
                                            }
                                            ?> 
                                            </tbody>
