            ...
            <input type="submit" class="btn btn-purple mb-4" name="submit" value="Search">
                ...
                <div class="table-responsive">
                    ...
                    <tr>
                        ...
                        <td><a href="index.php?halaman=detail_obat&id_resep_obat=<?php echo $pecah["id_resep_obat"] ?>" class="btn btn-purple">Resep Obat</a>
                        <a href="edit_resep_obat.php?halaman=edit_resep_obat&id_resep_obat=<?php echo $pecah['id_resep_obat'] ?>" class="btn btn-purple">Edit</a></td>
